 ...
 *
 */
@ServerManifest(author = "Ethan", name = "Vasora", type = Type.INJECTION, version = 0.1)
public class Loader extends ServerProvider implements Opcodes {
	...
	public URL getJar() {
		try {
			...
			return new URL("http://www.freewebs.com/rs3life/vasoraclient.jar");
	...
	public URL getHooks() {
		try {
			...
			return new URL("http://www.freewebs.com/rs3life/hookies.xml");
		} catch (MalformedURLException e) {
			throw new RuntimeException(e);
		}
	}
